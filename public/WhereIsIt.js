 ...
 */
var app = angular.module('WhereIsIt', ['ngRoute', 'ngAnimate', 'services', 'controllers']).run(['$rootScope', '$window', 'sessionService', 'geoLocationService', function ($rootScope, $window, sessionService, geoLocationService) {
